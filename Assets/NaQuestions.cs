...
public class NAQuestions : MonoBehaviour
{
    public GetNAFlag narandom;
    ...
    private void Start()
    {
        Debug.Log("Answer Input Field: " + (answerInput != null ? "Assigned" : "Not Assigned"));
